...
"""
    ...
    def update_skills(self, skill_id, new_skill_name):
        sql = """UPDATE skills SET skill_name = ?
                    WHERE skill_id = ?"""
...
#    manager.create_tables()
    ...
    manager.insert_project([(1, 'Test', 'http://test.com', 1)])
    manager.insert_skill(1, 'Test', 'Python')
    manager.get_project_skills('Test')